...
void AShotgun::FireShotgun(const TArray<FVector_NetQuantize>& HitTargets)
{
	...
	if (MuzzleFlashSocket)
	{
		...
		// Loop through DamageMap to get total damage for each character ( here are the cases exluding SSR )
		...
		// Launch SSR, to check if hit confirmed and if so damage will be applied using HitTargets we set before
